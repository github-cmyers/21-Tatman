...
<div class="min-h-[80vh] flex items-center justify-center px-4">
	<div class="w-full max-w-md">
		<div class="text-center mb-8">
			...
			<h1 class="text-2xl font-bold text-gray-900">21 Tatman Street</h1>
			<p class="text-gray-500 mt-1">Renter Portal</p>
		</div>
		...
		<form
			...
			class="bg-white rounded-xl p-8 shadow-sm border border-gray-100 space-y-5"
		>
			<h2 class="font-semibold text-gray-900 text-lg">Sign In</h2>
			...
			<div>
				...
				<input
					...
					value={form?.email ?? ''}
					autocomplete="email"
					class="w-full rounded-lg border border-gray-300 px-3 py-2.5 focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none"
				/>
			</div>
