...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
	<h1 class="text-2xl font-bold text-gray-900 mb-2">My Unit</h1>
	<p class="text-gray-600 mb-6">{myUnit.name} &middot; {myUnit.floor}</p>

	<!-- Unit Overview -->
	<div class="grid sm:grid-cols-3 gap-4 mb-6">
		<div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 text-center">
			<div class="text-3xl mb-1">🛏️</div>
			<div class="text-2xl font-bold text-gray-900">{myUnit.bedrooms}</div>
			<div class="text-sm text-gray-500">Bedrooms</div>
		</div>
		<div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 text-center">
			<div class="text-3xl mb-1">🚿</div>
			<div class="text-2xl font-bold text-gray-900">{myUnit.bathrooms}</div>
			<div class="text-sm text-gray-500">Bathroom</div>
		</div>
		<div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 text-center">
			<div class="text-3xl mb-1">📍</div>
			<div class="text-2xl font-bold text-gray-900">{myUnit.floor}</div>
	...
	<div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
		<div class="p-6 border-b border-gray-100">
			<h2 class="font-semibold text-gray-900">Rooms</h2>
		</div>
	...
	<div class="grid md:grid-cols-2 gap-6">
		...
		<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
			<h2 class="font-semibold text-gray-900 mb-3">Systems</h2>
			<dl class="space-y-3">
				<div>
					<dt class="text-xs font-medium text-gray-500 uppercase">Water Heater</dt>
					<dd class="text-sm text-gray-700 mt-0.5">{myUnit.waterHeater}</dd>
				</div>
			</dl>
		</div>
	</div>
